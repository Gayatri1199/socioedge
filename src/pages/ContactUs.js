      ...
      <div className="banner">
        ...
        <div className="cards-container">
          <ContactCard
            ...
            content="Speak to our chat support."
            anchorLink="Click to open chat"
            img="chat_bubble"
          />
          <ContactCard
            heading="Email Us"
            content="Reach us via email."
            anchorLink="info@socioedge.com"
            img="mail"
            href="mailto:info@socioedge.com"
          />{" "}
          <ContactCard
            heading="Call Us"
            content="Speak to our team.."
            anchorLink="+91-9923060619"
            img="Phone"
            href="tel:+91-9923060619"
          />{" "}
          <ContactCard
            heading="Send Enquiry"
            content="Share your query online."
            anchorLink="Fill the form"
            img="Info"
          />
        </div>
      </div>
